...
//    const newVal= name==="gender"?checked:value;
    // console.log(name,":", value)
    ...
    return (
            <FormControl w='80%' >
                <Flex  justifyContent='space-between' mt='5' >
                    ...
                    <Flex w='80%' gap='5' >
                        <Box w='40%' >
                            ...
                            <Input type='text' onChange={handleUser} value={user.first_name} name="first_name"  borderColor='gray.500'  />
                        </Box>
                        <Box w='40%' >
                            <FormLabel color='#666666' >Last name</FormLabel>
                            <Input type='text' onChange={handleUser} value={user.last_name} name="last_name"  borderColor='gray.500' />
                        </Box>
                    </Flex>
                </Flex>
                <Flex  justifyContent='space-between' mt='5'  >
                    ...
                    <Box w='80%'>
                        ...
                        <Input type='email' onChange={handleUser} value={user.email} name="email"  borderColor='gray.500'  />
                    </Box>
                </Flex>
                {/* <Flex  justifyContent='space-between' mt='5'  >
                ...
                <Flex  justifyContent='space-between' mt='5'  >
                    ...
                    <Box w='80%'>
                        <Input type='password' onChange={handleUser} value={user.password} name="password"  borderColor='gray.500'  />
                    </Box>
                </Flex>
                <Flex  justifyContent='space-between' mt='5'  >
                    ...
                    <Box w='80%'>
                        ...
                        <Input type='text' onChange={handleUser} value={user.userName} name="userName"  borderColor='gray.500'  />
                    </Box>
                </Flex>
                <Flex   mt='5'  >
                    <Text alignSelf='center' textAlign='left' w='20%' >Birth Date</Text>
                    <Box w='60%'>
                        <FormLabel color='#666666' mb='0' >Only your age will be publicly visible</FormLabel>
                        <Flex gap='5' >
                ...
                <Button disabled={user===initUser}  type='submit' h='60px' w='maxContent' pl='6' pr='6' m='5' bg='red.500' color='#fff' fontWeight='600' fontSize='1.5vw' onClick={handleSubmit} >{buttonText}</Button>
